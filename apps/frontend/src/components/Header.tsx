...
import { FaHome, FaCloudSun, FaWater, FaCar, FaNewspaper, FaBookOpen, FaInfoCircle, FaMapMarkedAlt, FaGlobe, FaSun, FaMoon } from 'react-icons/fa';
...
export function Header() {
  ...
  return (
    <header className="w-full bg-[var(--color-header-bg)] shadow-md transition-colors duration-300" role="banner">
      ...
      <div className="relative w-full py-10 px-6 text-center overflow-hidden">
        <Image
          src="/CapaMeteor.jpg"
          alt="Capa Meteor 2.0"
          fill
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          <ul className="flex items-center justify-center gap-1 overflow-x-auto py-2 text-sm" role="menubar">
            {NAV_ITEMS.map(item => {
